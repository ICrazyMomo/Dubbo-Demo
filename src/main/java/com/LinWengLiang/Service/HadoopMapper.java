 ...
 */
public class HadoopMapper extends Mapper<LongWritable, Text, DataItem, NullWritable> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        dataItem.set(fields[1], fields[2], fields[0], fields[3], Integer.parseInt(fields[4]));
        context.write(dataItem, v);
    }
}
